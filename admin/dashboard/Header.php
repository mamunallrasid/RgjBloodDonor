...
<head>
    ...
    <title>RGJ Donors Admin Panel</title>
    <style>
     .error{
      color: red;
    }
                ...
                <nav class="navbar navbar-expand">
                    ...
                    <div class="search-bar flex-grow-1" style="background-color: #edf0f5;">
                        <div class="position-relative search-bar-box">
                          <h2 style="text-align: center; font-size:27px; font-family: 'Ubuntu', sans-serif; margin-left:130px;">RGj Donors Admin Panel</h2>
                        </div>
                    </div>
                    ...
                    <div class="user-box dropdown">
                        <a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <div class="user-info ps-3">
                                ...
                                <p class="designattion mb-0"><?php echo $Admin_Name;?></p>
                            </div>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end">
                            ...
                            <li><a class="dropdown-item" onclick="adminLogout()"><i class='bx bx-log-out-circle'></i><span>Logout</span></a>
                            </li>
                        </ul>
                    </div>
                </nav>
